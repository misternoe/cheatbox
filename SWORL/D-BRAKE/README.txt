CHEATBOX_PROJECT
D-BRAKE v2.0 for Junkfood Custom Arcades SWORL Controller
...
All testing conducted on a SWORL Basic (Launch Model)
...
INSTALLATION
/////////////
1. Remove keycap (see manufacturer for info on this if needed)
